...
<p><img src="/images/db-redis-overview.png" alt="db-redis-overview.png"></p>
...
<li><strong>结构的读写能力：</strong> 对整个字符串或字符串的一部分进行操作；对整数货浮点数进行自增或自减操作；</li>
</ul>
...
<li><strong>结构的读写能力：</strong> 对链表的两端进行 push 或 pop 操作，读取单个或多个元素；根据值查找或删除元素；</li>
</ul>
...
<li><strong>结构的读写能力：</strong> 字符串的集合，包含基础的方法有看是否存在、添加、获取、删除；还包含计算交集、并集、差集等</li>
</ul>
...
<li><strong>结构的读写能力：</strong> 包含方法有添加、获取、删除单个元素</li>
</ul>
...
<li><strong>结构的读写能力：</strong> 字符串成语与浮点数之间的有序映射；元素的排列顺序有分数的大小决定；包含方法有添加、获取、删除单个元素以及根据分值范围或成员来获取元素</li>
</ul>
...
<p><img src="/images/基本散列算法.png" alt="基本散列算法.png"></p>
<p>实际上这就是最基本&quot;散列算法&quot;</p>
...
<p><img src="/images/哨兵集群.png" alt="哨兵集群.png"></p>
...
<p><img src="/images/哨兵分片集群.png" alt="哨兵分片集群.png"></p>
...
<p><img src="/images/布隆过滤器原理.png" alt="布隆过滤器原理.png"></p>
<p>semlinker</p>
...
<p>算法3:semlinker--&gt;4</p>
<p>会在布隆过滤器中产生如下影响</p>
<p><img src="/images/semlinker.png" alt="semlinker.png"></p>
...
<p>算法2:kakuqo--&gt;4</p>
<p>算法3:kakuqo--&gt;7</p>
<p><img src="/images/kakuqo.png" alt="kakuqo.png"></p>
<p>新的单词生成3,4,7个位置</p>
...
<p><img src="/images/布隆过滤器误判率公式.png" alt="布隆过滤器误判率公式.png"></p>
...
<p><img src="/images/布隆过滤器长度计算.png" alt="布隆过滤器长度计算.png"></p>
<p>布隆过滤器计算器</p>
