...
<p><img src="/images/nacos注册中心.png" alt="nacos注册中心.png"></p>
...
<p><img src="/images/nacos-bin目录.png" alt="nacos-bin目录.png"></p>
...
<p><img src="/images/nacos打开页面.png" alt="nacos打开页面.png"></p>
<p>如果是首次访问,会出现这个界面</p>
<p>登录系统</p>
<p>用户名:nacos</p>
<p>密码:nacos</p>
...
<img src="/images/注册服务.png" alt="注册服务.png"></p>
...
<p><img src="/images/nacos数据结构.png" alt="nacos数据结构.png"></p>
<p>namespace:命名空间</p>
<p>group:分组</p>
...
<p>在nacos中创建命名空间</p>
<p><img src="/images/nacos中创建命名空间.png" alt="nacos中创建命名空间.png"></p>
...
<p><img src="/images/nacos添加配置.png" alt="nacos添加配置.png"></p>
<p>添加cart模块数据库连接配置</p>
<p><img src="/images/nacos添加模块数据库连接配置.png" alt="nacos添加模块数据库连接配置.png"></p>
...
<p><img src="/images/springcloud项目加载配置文件的顺序.png" alt="springcloud项目加载配置文件的顺序.png"></p>
