...
<p>观察下面事务模型</p>
<p><img src="/seata运行原理（at）.png" alt="seata运行原理（at）.png"></p>
<p>上面结构是比较典型的远程调用结构</p>
<p>如果account操作数据库失败需要让order模块和storage模块撤销(回滚)操作</p>
<p>声明式事务不能完成这个操作</p>
<p>需要Seata来解决</p>
<p>解决模型如下</p>
<p><img src="/seata模型.png" alt="seata模型.png"></p>
<p>Seata构成部分包含</p>
<ul>
<li>事务协调器TC</li>
<li>事务管理器TM</li>
...
<p>也是解压之后的bin目录下</p>
<p><img src="/seata的bin目录.png" alt="seata的bin目录.png"></p>
...
<p><img src="/seata常见错误1.png" alt="seata常见错误1.png"></p>
