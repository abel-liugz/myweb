...
<p><img src="/本地调用.png" alt="本地调用.png"></p>
<p>上面图是老婆和老公在家的时,老婆让老公洗碗的调用流程</p>
<p>但这个流程是本地的,</p>
<p>我们再换成远程调用的图片</p>
<p><img src="/远程调用.png" alt="远程调用.png"></p>
...
<p><img src="/dubbo发展历程.png" alt="dubbo发展历程.png"></p>
...
<p><img src="/dubbo注册与发现.png" alt="dubbo注册与发现.png"></p>
...
<p><img src="/dubbo确定调用关系.png" alt="dubbo确定调用关系.png"></p>
...
<p><img src="/负载均衡.png" alt="负载均衡.png"></p>
...
<p><img src="/负载均衡随机分配策略.png" alt="负载均衡随机分配策略.png"></p>
<p>随机生成随机数</p>
<p>在哪个范围内让哪个服务器运行</p>
<p>优点:</p>
...
<p><img src="/负载均衡权重平均分配.png" alt="负载均衡权重平均分配.png"></p>
