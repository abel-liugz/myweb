...
<p>直到B返回结果后A才能运行</p>
<p><img src="/dubbo远程调用的性能问题.png" alt="dubbo远程调用的性能问题.png"></p>
...
<p><img src="/消息队列的特征.png" alt="消息队列的特征.png"></p>
<blockquote>
<p>常见面试题:消息队列的特征</p>
</blockquote>
<ul>
...
<p>kafka软件结构</p>
<p><img src="/kafka软件结构.png" alt="kafka软件结构.png"></p>
...
<p>然后路径不要有空格和中文</p>
<p><img src="/kafka安装.png" alt="kafka安装.png"></p>
...
<p><img src="/erlang环境变量.png" alt="erlang环境变量.png"></p>
...
<p><img src="/rabbitmq启动.png" alt="rabbitmq启动.png"></p>
<p>运行完成后</p>
