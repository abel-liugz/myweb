...
<p><img src="/elasticsearch查询原理.png" alt="elasticsearch查询原理.png"></p>
...
<p><img src="/es的bin目录.png" alt="es的bin目录.png"></p>
<p>运行之后可能看到下面界面</p>
<p><img src="/es启动后的dos窗口.png" alt="es启动后的dos窗口.png"></p>
<p>这个界面不能关闭,一旦关闭ES就停止了</p>
<p>我们启动ES双击这个bat文件即可,当然也可以设置Idea的shell script</p>
<p>验证ES是否在运行</p>
<p>浏览器输入地址:localhost:9200看到如下内容即可</p>
<p><img src="/浏览器访问es.png" alt="浏览器访问es.png"></p>
<p>mac系统启动</p>
...
<p><img src="/idea中创建http_request.png" alt="idea中创建http_request.png"></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/http_request界面注解.png" alt="http_request界面注解.png"></p>
...
<p><img src="/安装ik.png" alt="安装ik.png"></p>
<p>安装插件之后要重启ES才能生效</p>
<p>关闭ES窗口之后再启动ES即可</p>
...
<p><img src="/es保存数据的结构.png" alt="es保存数据的结构.png"></p>
<ul>
<li>
...
<p><img src="/springdata页面.png" alt="springdata页面.png"></p>
...
<p><img src="/logstash.png" alt="logstash.png"></p>
